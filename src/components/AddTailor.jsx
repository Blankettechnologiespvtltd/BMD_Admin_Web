...
//             <DocIcon
//               size={18}
//               className={has ? "text-white" : "text-gray-400"}
//             />
//           </div>
//           <div>
//             <p
//               className={`text-sm font-bold leading-tight ${has ? "text-white" : "text-gray-700"}`}
//             >
//               {label}
//             </p>
//             <p
//               className={`text-xs mt-0.5 ${has ? "text-teal-100" : "text-gray-400"}`}
//             >
...
//             <CloudUpload
//               size={28}
//               className="text-gray-300 group-hover:text-[#007A7A] transition-colors"
//             />
...
//         if (!["aadhar", "pan_card", "other"].includes(key)) {
...
//                     Accepted formats: JPG, PNG, PDF &nbsp;·&nbsp; Max 5 MB per
//                     file &nbsp;·&nbsp; All 3 documents recommended
//                   </p>
//                 </div>
//               </div>
